  ...
  fetchData() {
    ...
    getFile('opps.json', options).then(file => {
      ...
      this.setState({
        ...
        name: opp[0].name,
        id: opp[0].id,
        lastName: opp[0].lastName,
        twitterHandle: opp[0].twitterHandle,
        email: opp[0].email,
        phoneNumber: opp[0].phoneNumber,
        birthDate: opp[0].birthDate,
        country: opp[0].country,
        region: opp[0].region,
        sex: opp[0].sex,
        blockstackId: opp[0].blockstackId,
        contactDate: opp[0].contactDate,
